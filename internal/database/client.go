...
// // GetBalance retrieves the balance of an account from the database.
// func (c *Client) GetBalance(ctx context.Context, accountID uuid.UUID) (int64, error) {
// 	var balance int64
...
import (
	...
	"fmt"
	"log"
	"math/big" // <-- Adicionar import
	"pix-privado/internal/models"

	"github.com/ethereum/go-ethereum/common" // <-- Adicionar import
	"github.com/google/uuid"
	"github.com/jackc/pgx/v5/pgxpool"
)
